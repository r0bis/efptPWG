#$Rev: 12179 $ .
data <- read.table("Latvia_R_data_file.csv", sep=",", quote = "'", na.strings=c("","\"\""), stringsAsFactors=FALSE)
...
attributes(data)$variable.labels[4] <- "datestamp"
...
attributes(data)$variable.labels[6] <- "ipaddr"
names(data)[6] <- "ipaddr"

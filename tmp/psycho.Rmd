...
```{r}
names <- names(answering_countries)
...
country_choropleth(DF,
                 ...
                 legend     = "Number",
                 zoom       = c("belarus", "croatia", "france", "republic of serbia","united kingdom", "switzerland", "albania", "estonia", "lithuania", "bosnia and herzegovina", "latvia", "bulgaria", "finland", "germany", "spain", "belgium", "israel", "greece", "italy", "czech republic", "slovenia", "france", "romania", "portugal", "ireland", "poland", "ukraine", "austria"))
```

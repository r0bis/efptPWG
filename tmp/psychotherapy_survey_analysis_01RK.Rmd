...
# plot the data
partPlot <- ggplot(ca, aes(reorder(x = country, count), y = count, fill=count )) + 
...
partPlot + coord_flip() +   annotate("text",label = labPNumber, x =4.55, y = 85.7, hjust = 'right') +

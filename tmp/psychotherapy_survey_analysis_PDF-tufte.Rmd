...
\newthought{And as we can see} this can be quite interesting. `r stri_rand_lipsum(2)`
...
```{r test_table, results='asis', echo=FALSE, eval=FALSE}
...
# print(xt.Q5other)
setwd(oldwd)
print(xtable(df.sex, caption="Sex table"))
```
